...
public class MossyMantleStairsBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:mossy_mantle_stairs")
	public static final Block block = null;
	public MossyMantleStairsBlock(InfinityAndOresModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1f, 6f).setLightLevel(s -> 0)
