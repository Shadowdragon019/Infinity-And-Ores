...
public class MossyMantleBrickSlabBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:mossy_mantle_brick_slab")
	public static final Block block = null;
	public MossyMantleBrickSlabBlock(InfinityAndOresModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_mantle_brick_slab");
		}
