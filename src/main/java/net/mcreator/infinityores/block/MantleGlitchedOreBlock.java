...
public class MantleGlitchedOreBlock extends InfinityAndOresModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}.withConfiguration(new OreFeatureConfig(new BlockMatchRuleTest(MantleBlock.block.getDefaultState().getBlock()) {
		...
		}, block.getDefaultState(), 1)).range(5).square().func_242731_b(1));
	}
}
