...
public class MantleOpristoniumOreBlock extends InfinityAndOresModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("infinity_and_ores:mantle_opristonium_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("mantle_opristonium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("infinity_and_ores:mantle_opristonium_ore"),
					configuredFeature);
		}
	}
	@SubscribeEvent
