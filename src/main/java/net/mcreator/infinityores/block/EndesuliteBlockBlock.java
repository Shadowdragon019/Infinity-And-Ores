...
public class EndesuliteBlockBlock extends InfinityAndOresModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(7f, 8f).lightValue(0).harvestLevel(4)
