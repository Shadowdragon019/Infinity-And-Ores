...
public class MossyMantleBrickWallBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:mossy_mantle_brick_wall")
	public static final Block block = null;
	public MossyMantleBrickWallBlock(InfinityAndOresModElements instance) {
		super(instance, 103);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_mantle_brick_wall");
		}
