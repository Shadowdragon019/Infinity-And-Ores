...
public class MossyMantleWallBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:mossy_mantle_wall")
	public static final Block block = null;
	public MossyMantleWallBlock(InfinityAndOresModElements instance) {
		super(instance, 101);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_mantle_wall");
		}
