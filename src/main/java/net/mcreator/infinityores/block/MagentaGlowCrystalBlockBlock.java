...
public class MagentaGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:magenta_glow_crystal_block")
	public static final Block block = null;
	public MagentaGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 545);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("magenta_glow_crystal_block");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.843137254902f, 0.282352941176f, 1f};
		}
