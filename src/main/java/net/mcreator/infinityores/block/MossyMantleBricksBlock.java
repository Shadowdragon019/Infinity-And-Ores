...
public class MossyMantleBricksBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:mossy_mantle_bricks")
	public static final Block block = null;
	public MossyMantleBricksBlock(InfinityAndOresModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_mantle_bricks");
		}
