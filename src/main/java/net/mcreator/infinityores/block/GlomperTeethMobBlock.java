...
public class GlomperTeethMobBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:glomper_teeth_mob")
	public static final Block block = null;
	public GlomperTeethMobBlock(InfinityAndOresModElements instance) {
		super(instance, 351);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				GlomperRevealProcedureProcedure.executeProcedure($_dependencies);
			}
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("glomper_teeth_mob", "glomper_teeth_mob", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.CAVE_AIR.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 1)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(4, 0, 0, 128))));
		}
	}
}
