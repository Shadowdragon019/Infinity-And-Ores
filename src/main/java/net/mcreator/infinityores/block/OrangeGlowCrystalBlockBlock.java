...
public class OrangeGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:orange_glow_crystal_block")
	public static final Block block = null;
	public OrangeGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 539);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_glow_crystal_block");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{1f, 0.341176470588f, 0f};
		}
