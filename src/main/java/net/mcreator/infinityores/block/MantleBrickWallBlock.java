...
public class MantleBrickWallBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:mantle_brick_wall")
	public static final Block block = null;
	public MantleBrickWallBlock(InfinityAndOresModElements instance) {
		super(instance, 102);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mantle_brick_wall");
		}
