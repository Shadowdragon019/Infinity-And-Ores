...
public class CyanGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:cyan_glow_crystal_block")
	public static final Block block = null;
	public CyanGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 548);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cyan_glow_crystal_block");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.003921568627f, 0.741176470588f, 0.658823529412f};
		}
