...
public class BlueGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:blue_glow_crystal_block")
	public static final Block block = null;
	public BlueGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 544);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_glow_crystal_block");
		}
