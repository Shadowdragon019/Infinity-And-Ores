...
public class PolishedMantleSlabBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:polished_mantle_slab")
	public static final Block block = null;
	public PolishedMantleSlabBlock(InfinityAndOresModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_mantle_slab");
		}
