...
public class SlimyOakTrapdoorBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:slimy_oak_trapdoor")
	public static final Block block = null;
	public SlimyOakTrapdoorBlock(InfinityAndOresModElements instance) {
		super(instance, 609);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("slimy_oak_trapdoor");
		}
