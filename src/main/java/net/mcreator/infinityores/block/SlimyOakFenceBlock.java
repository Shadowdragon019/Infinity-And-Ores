...
public class SlimyOakFenceBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:slimy_oak_fence")
	public static final Block block = null;
	public SlimyOakFenceBlock(InfinityAndOresModElements instance) {
		super(instance, 612);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("slimy_oak_fence");
		}
