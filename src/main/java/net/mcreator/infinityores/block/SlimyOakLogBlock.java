...
public class SlimyOakLogBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:slimy_oak_log")
	public static final Block block = null;
	public SlimyOakLogBlock(InfinityAndOresModElements instance) {
		super(instance, 605);
	}
