...
public class BlackGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:black_glow_crystal_block")
	public static final Block block = null;
	public BlackGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 553);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_glow_crystal_block");
		}
