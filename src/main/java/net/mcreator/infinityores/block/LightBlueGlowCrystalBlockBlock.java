...
public class LightBlueGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:light_blue_glow_crystal_block")
	public static final Block block = null;
	public LightBlueGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 543);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("light_blue_glow_crystal_block");
		}
