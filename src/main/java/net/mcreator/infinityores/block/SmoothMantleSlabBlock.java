...
public class SmoothMantleSlabBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:smooth_mantle_slab")
	public static final Block block = null;
	public SmoothMantleSlabBlock(InfinityAndOresModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_mantle_slab");
		}
