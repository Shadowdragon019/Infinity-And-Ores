...
import net.mcreator.infinityores.procedures.StrippedGhostwoodProcedureProcedure;
...
public class GhostwoodWoodBlock extends InfinityAndOresModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("ghostwood_wood");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				StrippedGhostwoodProcedureProcedure.executeProcedure($_dependencies);
			}
