...
public class SlimyOakStairsBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:slimy_oak_stairs")
	public static final Block block = null;
	public SlimyOakStairsBlock(InfinityAndOresModElements instance) {
		super(instance, 610);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("slimy_oak_stairs");
		}
