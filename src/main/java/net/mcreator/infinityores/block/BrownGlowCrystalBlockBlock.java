...
public class BrownGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:brown_glow_crystal_block")
	public static final Block block = null;
	public BrownGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 552);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brown_glow_crystal_block");
		}

		@Override
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.4f, 0.2f, 0f};
		}
