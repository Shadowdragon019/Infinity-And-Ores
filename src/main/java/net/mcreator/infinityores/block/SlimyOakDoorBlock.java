...
public class SlimyOakDoorBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:slimy_oak_door")
	public static final Block block = null;
	public SlimyOakDoorBlock(InfinityAndOresModElements instance) {
		super(instance, 608);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("slimy_oak_door");
		}
