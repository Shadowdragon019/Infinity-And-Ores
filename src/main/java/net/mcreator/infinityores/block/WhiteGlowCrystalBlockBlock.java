...
public class WhiteGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:white_glow_crystal_block")
	public static final Block block = null;
	public WhiteGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 549);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("white_glow_crystal_block");
		}
