...
public class GlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:glow_crystal_block")
	public static final Block block = null;
	public GlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 556);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("glow_crystal_block");
		}
