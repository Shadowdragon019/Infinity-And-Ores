...
public class LightGrayGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:light_gray_glow_crystal_block")
	public static final Block block = null;
	public LightGrayGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 550);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("light_gray_glow_crystal_block");
		}
