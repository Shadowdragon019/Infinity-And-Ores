...
public class YellowGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:yellow_glow_crystal_block")
	public static final Block block = null;
	public YellowGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 540);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellow_glow_crystal_block");
		}
