...
public class GrayGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:gray_glow_crystal_block")
	public static final Block block = null;
	public GrayGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 551);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gray_glow_crystal_block");
		}
