...
public class GhostwoodFenceGateBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:ghostwood_fence_gate")
	public static final Block block = null;
	public GhostwoodFenceGateBlock(InfinityAndOresModElements instance) {
		super(instance, 109);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ghostwood_fence_gate");
		}
