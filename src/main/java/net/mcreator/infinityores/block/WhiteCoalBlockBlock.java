...
public class WhiteCoalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:white_coal_block")
	public static final Block block = null;
	public WhiteCoalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("white_coal_block");
		}
