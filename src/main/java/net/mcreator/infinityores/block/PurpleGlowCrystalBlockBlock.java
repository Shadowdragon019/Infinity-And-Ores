...
public class PurpleGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:purple_glow_crystal_block")
	public static final Block block = null;
	public PurpleGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 546);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_glow_crystal_block");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.576470588235f, 0f, 1f};
		}
