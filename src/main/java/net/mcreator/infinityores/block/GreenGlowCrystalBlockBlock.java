...
public class GreenGlowCrystalBlockBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:green_glow_crystal_block")
	public static final Block block = null;
	public GreenGlowCrystalBlockBlock(InfinityAndOresModElements instance) {
		super(instance, 542);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_glow_crystal_block");
		}
		...
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0f, 0.364705882353f, 0f};
		}
