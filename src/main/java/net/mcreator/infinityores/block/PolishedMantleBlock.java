...
public class PolishedMantleBlock extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:polished_mantle")
	public static final Block block = null;
	public PolishedMantleBlock(InfinityAndOresModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_mantle");
		}
