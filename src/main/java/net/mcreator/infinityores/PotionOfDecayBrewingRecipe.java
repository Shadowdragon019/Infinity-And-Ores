...
import net.mcreator.infinityores.potion.PotionOfDecayPotion;
import net.mcreator.infinityores.item.VirusCoreItem;

import java.lang.reflect.Method;

@InfinityAndOresModElements.ModElement.Tag
public class PotionOfDecayBrewingRecipe extends InfinityAndOresModElements.ModElement {
	/**
	 * Do not remove this constructor
	 */
	public PotionOfDecayBrewingRecipe(InfinityAndOresModElements instance) {
		super(instance, 410);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		try {
			...
			Object obj = mth.invoke(null, Potions.AWKWARD, VirusCoreItem.block, PotionOfDecayPotion.potionType);
