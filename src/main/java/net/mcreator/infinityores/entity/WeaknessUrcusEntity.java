...
import net.mcreator.infinityores.entity.renderer.WeaknessUrcusRenderer;
...
public class WeaknessUrcusEntity extends InfinityAndOresModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(0.4f, 0.4f)).build("weakness_urcus").setRegistryName("weakness_urcus");
	public WeaknessUrcusEntity(InfinityAndOresModElements instance) {
		super(instance, 145);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WeaknessUrcusRenderer.ModelRegisterHandler());
