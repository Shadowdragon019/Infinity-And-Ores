...
public class PoisonUrcusEntity extends InfinityAndOresModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -15592942, -16099328, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("poison_urcus"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.AMBIENT).add(new Biome.SpawnListEntry(entity, 10, 1, 4));
		}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				PoisonUrcusCollidingProcedureProcedure.executeProcedure($_dependencies);
			}
		}
