...
import net.mcreator.infinityores.entity.renderer.CrawlantRenderer;
...
public class CrawlantEntity extends InfinityAndOresModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.8f, 0.8f)).build("crawlant").setRegistryName("crawlant");
	public CrawlantEntity(InfinityAndOresModElements instance) {
		super(instance, 148);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CrawlantRenderer.ModelRegisterHandler());
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 15, 3, 5));
	}
