...
import net.mcreator.infinityores.procedures.WitherUrcusHitProcedureProcedure;
import net.mcreator.infinityores.procedures.WitherUrcusCollideProcedureProcedure;
import net.mcreator.infinityores.item.VirusCoreItem;
import net.mcreator.infinityores.entity.renderer.WitherUrcusRenderer;
...
public class WitherUrcusEntity extends InfinityAndOresModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(0.4f, 0.4f)).build("wither_urcus").setRegistryName("wither_urcus");
	public WitherUrcusEntity(InfinityAndOresModElements instance) {
		super(instance, 146);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WitherUrcusRenderer.ModelRegisterHandler());
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 5, 1, 4));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				$_dependencies.put("sourceentity", sourceentity);
				WitherUrcusCollideProcedureProcedure.executeProcedure($_dependencies);
			}
		}
