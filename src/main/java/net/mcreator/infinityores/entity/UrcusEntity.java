...
import net.mcreator.infinityores.procedures.UrcusCollideProcedureProcedure;
import net.mcreator.infinityores.item.VirusCoreItem;
import net.mcreator.infinityores.entity.renderer.UrcusRenderer;
...
public class UrcusEntity extends InfinityAndOresModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(0.4f, 0.4f)).build("urcus").setRegistryName("urcus");
	public UrcusEntity(InfinityAndOresModElements instance) {
		super(instance, 143);
		FMLJavaModLoadingContext.get().getModEventBus().register(new UrcusRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				UrcusCollideProcedureProcedure.executeProcedure($_dependencies);
			}
		}
