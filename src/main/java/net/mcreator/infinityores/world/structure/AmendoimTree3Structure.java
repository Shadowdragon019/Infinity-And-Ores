...
public class AmendoimTree3Structure extends InfinityAndOresModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public AmendoimTree3Structure(InfinityAndOresModElements instance) {
		super(instance, 303);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("amendoim_tree_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("infinity_and_ores:amendoim_tree_3"), configuredFeature);
		}
	}
	@SubscribeEvent
