...
public class AmendoimTree6Structure extends InfinityAndOresModElements.ModElement {
	...
	public AmendoimTree6Structure(InfinityAndOresModElements instance) {
		super(instance, 306);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("amendoim_tree_6"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("infinity_and_ores:amendoim_tree_6"), configuredFeature);
		}
	}
	@SubscribeEvent
