...
import net.mcreator.infinityores.procedures.AmendoimTreeWorldGenerationProcedureProcedure;
...
public class AmendoimTreeGenerator6Structure extends InfinityAndOresModElements.ModElement {
	public AmendoimTreeGenerator6Structure(InfinityAndOresModElements instance) {
		super(instance, 312);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 750000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("infinity_and_ores", "spawn5"));
						if (template == null)
							return false;
								...
								.addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK).setChunk(null).setIgnoreEntities(false));
						{
							...
							AmendoimTreeWorldGenerationProcedureProcedure.executeProcedure($_dependencies);
						}
					}
				}
				return true;
