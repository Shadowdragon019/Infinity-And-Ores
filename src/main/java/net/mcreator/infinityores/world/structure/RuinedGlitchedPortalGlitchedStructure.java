...
public class RuinedGlitchedPortalGlitchedStructure extends InfinityAndOresModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("infinity_and_ores", "ruined_glitched_portal_glitch"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("ruined_glitched_portal_glitched"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("infinity_and_ores:ruined_glitched_portal_glitched"),
					configuredFeature);
		}
	}
	@SubscribeEvent
