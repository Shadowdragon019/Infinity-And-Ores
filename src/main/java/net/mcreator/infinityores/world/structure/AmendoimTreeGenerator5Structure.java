...
public class AmendoimTreeGenerator5Structure extends InfinityAndOresModElements.ModElement {
	public AmendoimTreeGenerator5Structure(InfinityAndOresModElements instance) {
		super(instance, 311);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 750000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("infinity_and_ores", "spawn4"));
						if (template == null)
							return false;
