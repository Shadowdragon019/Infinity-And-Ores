...
public class AmendoimTreeGeneratorStructure extends InfinityAndOresModElements.ModElement {
	public AmendoimTreeGeneratorStructure(InfinityAndOresModElements instance) {
		super(instance, 306);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 750000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("infinity_and_ores", "spawn"));
						if (template == null)
							return false;
