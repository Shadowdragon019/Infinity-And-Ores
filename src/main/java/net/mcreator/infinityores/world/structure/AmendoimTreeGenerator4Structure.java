...
public class AmendoimTreeGenerator4Structure extends InfinityAndOresModElements.ModElement {
	public AmendoimTreeGenerator4Structure(InfinityAndOresModElements instance) {
		super(instance, 310);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 750000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("infinity_and_ores", "spawn3"));
						if (template == null)
							return false;
