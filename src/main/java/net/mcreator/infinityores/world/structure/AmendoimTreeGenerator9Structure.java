...
public class AmendoimTreeGenerator9Structure extends InfinityAndOresModElements.ModElement {
	public AmendoimTreeGenerator9Structure(InfinityAndOresModElements instance) {
		super(instance, 315);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 750000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("infinity_and_ores", "spawn8"));
						if (template == null)
							return false;
