...
public class AmendoimTreeReplacement2Structure extends InfinityAndOresModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public AmendoimTreeReplacement2Structure(InfinityAndOresModElements instance) {
		super(instance, 424);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("amendoim_tree_replacement_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("infinity_and_ores:amendoim_tree_replacement_2"),
					configuredFeature);
		}
	}
	@SubscribeEvent
