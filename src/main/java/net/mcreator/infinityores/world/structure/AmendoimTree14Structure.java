...
public class AmendoimTree14Structure extends InfinityAndOresModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("amendoim_tree_14"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("infinity_and_ores:amendoim_tree_14"), configuredFeature);
		}
	}
	@SubscribeEvent
