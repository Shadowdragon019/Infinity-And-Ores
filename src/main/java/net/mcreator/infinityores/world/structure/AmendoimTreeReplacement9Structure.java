...
public class AmendoimTreeReplacement9Structure extends InfinityAndOresModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public AmendoimTreeReplacement9Structure(InfinityAndOresModElements instance) {
		super(instance, 416);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("amendoim_tree_replacement_9"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("infinity_and_ores:amendoim_tree_replacement_9"),
					configuredFeature);
		}
	}
	@SubscribeEvent
