...
import net.mcreator.infinityores.procedures.GlitchedCrystalProcedureProcedure;
...
public class GlitchedCrystalItemItem extends InfinityAndOresModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("glitched_crystal");
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				GlitchedCrystalProcedureProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
