...
public class FiddlyPotionItem extends InfinityAndOresModElements.ModElement {
	@ObjectHolder("infinity_and_ores:fiddly_potion")
	public static final Item block = null;
	public FiddlyPotionItem(InfinityAndOresModElements instance) {
		super(instance, 600);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77No Effects"));
		}
