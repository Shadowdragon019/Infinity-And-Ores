	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				InfinityAndOresMod.LOGGER.warn("Failed to load dependency entity for procedure WitherUrcusCollideProcedure!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				InfinityAndOresMod.LOGGER.warn("Failed to load dependency sourceentity for procedure WitherUrcusCollideProcedure!");
			return;
		}
