...
public class AmendoimTree2ProcedureProcedure extends InfinityAndOresModElements.ModElement {
	public AmendoimTree2ProcedureProcedure(InfinityAndOresModElements instance) {
		super(instance, 375);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure AmendoimTree2Procedure!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure AmendoimTree2Procedure!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure AmendoimTree2Procedure!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure AmendoimTree2Procedure!");
			return;
		}
